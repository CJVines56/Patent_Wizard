...
def run_one_with_graph(app, question: str, app_rpm_budget: int = 60) -> dict:
    ...
    try:
        ...
        project_name=os.getenv("LANGSMITH_PROJECT", "default"),
            ...
            q_metadata = final_state["metadata"]
            print(q_metadata)
        ...
        return {"question": cleaned_q, "answer": answer, "contexts": contexts, "metadata": q_metadata}
...
def full_workflow(question):
    ...
    #TODO Implement ColBERT rather than this model
