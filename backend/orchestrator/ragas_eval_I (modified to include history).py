...
def run_one_with_graph(app, question: str, thread_id: str, app_rpm_budget: int = 60) -> dict:
    ...
    try:
        with trace(
            ...
            raw_contexts: List[Dict[str, Any]] = final_state.get("retrieved_context") or []
            print(raw_contexts)
            contexts: List[str] = [
                c.get("text", "")
...
if __name__ == "__main__":
    ...
    rows = [run_one_with_graph(app, q, thread_id=thread_id, app_rpm_budget=60) for q in questions]
